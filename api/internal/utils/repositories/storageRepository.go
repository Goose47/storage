...
func (repo *StorageRepository) Item(key string) (*models.StorageItem, error) {
	var result bson.M
	err := repo.collection.
...
func (repo *StorageRepository) SaveItem(key string, item *models.StorageItem) (string, error) {
...
func (repo *StorageRepository) DeleteItem(key string) (*models.StorageItem, error) {
	var result bson.M
	err := repo.collection.
